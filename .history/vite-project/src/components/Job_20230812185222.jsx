        ...
        <div>
            ...
            <div className='jobContainer flex gap-10 justify-center flex-wrap items-center py-10'>
                ...
                <div className='group group/items singleJob w-[20] bg-white rounded[10px] hover:bg-blueColor shadow-lg shadow-greyIsh-400/700 hover:shadow-lg'>
                    ...
                    <p className='text-[13px text-[#95959 pt-[20px] border-t-[20px] group-hover:text-white'>
                        The way to go if hoping to live in our land of great opportunities and possibilities. Do not guess to much <link>apply now</link>
